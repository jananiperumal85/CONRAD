...
public class DefectPixelInterpolation {
	...
	{
		//padding          will increase the width by adding zeros in freq domain
		Grid2DComplex G=new Grid2DComplex(image,zeroPadding);
		Grid2DComplex W=new Grid2DComplex(mask,zeroPadding);
		
		
		//fourier transform for G and W (defect and Mask Image in freq domain)
		G.transformForward();
		W.transformForward();
		...
		for(int i = 0; i < maxIter; i++) // Big iteration loop for removing the defect pixel which will end by checking convergence
		{
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/ti16xavo/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
		String filenameMask = "/proj/i5dmip/ti16xavo/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
		...
		defectImage.getGridOperator().multiplyBy(defectImage,mask);//defectimage is copy of image and this action wont return value and result stored in defectimage
